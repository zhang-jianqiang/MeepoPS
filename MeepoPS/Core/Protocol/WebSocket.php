                ...
                case 0x9:
                    ...
                    if ($connect->instance->callbackPing) {
                        try {
                            ...
                            Log::write('MeepoPS: execution callback function callbackPing-' . $connect->instance->callbackPing . ' throw exception', 'ERROR');
                        }
                    } else {
                ...
                case 0xa:
                    ...
                    if ($connect->instance->callbackPong) {
                        try {
                            ...
                            Log::write('MeepoPS: execution callback function callbackPong-' . $connect->instance->callbackPong . ' throw exception', 'ERROR');
                        }
                    }
                    //如果数据中消息的长度为假,则从接收数据缓冲区中删除规定的消息头部分.
                    if (!$messageLength) {
